      ...
      {!savedCharacterData ? (
        <PermalinkButtonContainer>
          <PermalinkButton
            ...
            onClick={() => {
              history.push(`/savedCharacter/1&${characterName}&${classSelection}&${traits}&${abilityScores}&${hitPoints}&${languages}&${spells}&${equipment.characterEquipmentString}&${equipment.slotsToFill}`);
            }}
          >
            Permalink
          </PermalinkButton>
