...
import { STR, DEX, CON, INT, WIS, CHA } from '../../constants/abilityScoreConstants';
...
const ClassIconAndAbilityScores: React.SFC<Props> = ({ classSelection, abilityScores, strMod, dexMod, conMod, intMod, wisMod, chaMod }) => {
