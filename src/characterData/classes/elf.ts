...
export const elf = {
  ...
  abilities: [
    ...
    "<strong>Detect Secret Doors:</strong> Elves have keen eyes that allow them, when actively searching, to detect hidden and secret doors with a 2-in-6 chance (see Searching in B/X Essentials: Core Rules).",
    "<strong>Immunity to Ghoul Paralysis:</strong> Elves are completely unaffected by the paralysis ghouls can inflict.",
    "<strong>Infravision:</strong> Elves have infravision to 60’ (see Light, Vision, and Visibility in B/X Essentials: Core Rules).",
    "<strong>Listening at Doors:</strong> Elves have a 2-in-6 chance of hearing noises (see Doors, B/X Essentials: Core Rules).",
