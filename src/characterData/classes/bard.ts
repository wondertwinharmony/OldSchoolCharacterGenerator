...
/**
 * @todo
 * if bard class add a random esoteric instrument to
 * equipment
 * @see https://www.music.iastate.edu/antiqua/instruments
 *
 * @todo
 * for random gear -> make instrument use this random list
 * too
 */
