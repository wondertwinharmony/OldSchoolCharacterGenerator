...
export const clericEquipment = [
  ...
  [
    "<strong>Leather Armor</strong> (2 slots)",
    "<strong><strong></strong> (Damage: 1d4, Qualities: Blunt, Melee, Slow, Two-handed)",
    "<strong>6 Torches</strong>",
    "<strong>Waterskin</strong>",
    "<strong>2 Travel rations</strong> (1/day)",
    "<strong>50' Rope</strong>",
  ...
  [
    ...
    "<strong>4 Flasks oil</strong>",
    "<strong>2 Travel rations</strong> (1/day)",
    "<strong>10' Pole</strong>",
    "<strong>Wooden Holy Symbol</strong>",
    "<strong>Small Sack</strong>"
  ],
  [
    "<strong>Plate Armor</strong> (3 slots)",
...
export const fighterEquipment = [
  ...
  [
    ...
    "<strong>3 Daggers</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
    "<strong>6 Torches</strong>",
    "<strong>Waterskin</strong>",
    "<strong>2 Travel rations</strong> (1/day)",
    "<strong>50' Rope</strong>",
    "<strong>2 Flasks oil</strong>"
  ],
  [
    "<strong>Plate Armor</strong> (3 slots)",
    "<strong>Shield</strong>",
...
export const magicUserEquipment = [
  ...
  [
    ...
    "<strong>2 Travel rations</strong> (1/day)",
    "<strong>10' Pole</strong>",
    "5 Flasks of oil</strong>",
    "Silver Mirror</strong>",
    `${getMagicUserScrollSpell()}`
  ],
  [
    "<strong>Dagger</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
...
export const thiefEquipment = [
  ...
  [
    "<strong>Leather Armor</strong> (2 slots)",
    "<strong>Sword</strong></strong> (Damage: 1d8, Qualities: Melee, 2 slots)",
    "<strong>Dagger</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
    "<strong>Dagger</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
    "<strong>Dagger</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
    "<strong>Dagger</strong> (Damage: 1d4, Qualities: Melee, Missile (5’-10’ / 11’-20’ / 21’-30’))",
