import { getIllusionistScrollSpell } from "../../utils/getRandomSpellScroll";

/**
 * Illusionist equipment kits cannot be higher than 9 slots.
 * 9 + starting gold = 10
 */
export const illusionistInventory = [
  {
    silverDagger: {
      description:
    ...
    illusionistSpellScroll: {
      description: `${getIllusionistScrollSpell()}`,
      slots: "1"
    },
    spellbook: {
