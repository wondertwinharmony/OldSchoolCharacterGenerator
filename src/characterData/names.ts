export const firstNames = ["Conaan", "Conan", "Dinkle", "Wyeth", "Beavis", "Gambrinus", "Rendlesham", "Abigayl", "Aebria", "Aeobreia", "Breia", "Aedria", "Aodreia", "Dreia", "Aeliya", "Aliya",
               ...
               "Elyana", "Eliana", "Eva", "Falyne", "Fraga", "Genaesis", "Genaesys", "Gianna", "Jianna", "Janna",
               "Graece", "Grassa", "Haenna", "Hanna", "Halya", "Harperia", "Peria", "Hazyl", "Hazel",
               "Jasmyne", "Jasmine", "Jeuquan", "Jocelyne", "Joceline", "Celine", "Kaelia", "Kaelya", "Kathryne", "Kathrine",
               "Kayla", "Kaila", "Kymber", "Kimbera", "Kreston", "Layla", "Laylanna", "Leia", "Leya", "Leah",
               "Lilia", "Lylia", "Luna", "Maedisa", "Maelania", "Melania", "Maya", "Mya", "Myla",
               "Milae", "Naomi", "Naome", "Natalya", "Nachelus", "Talya", "Nathylie", "Nataliae", "Thalia", "Nicola",
               ...
               "Caerlotta", "Sophya", "Stella", "Stylla", "Tajur", "Valentyna", "Valerya", "Valeria", "Valia", "Valea",
...
export const surnames = ["O'Blivion", "Brandshaft", "Dinklage", "Bright", "Brown", "Browne", "Brushfire", "Camp", "Campman", "Canyon", "Cricketts", "Crickets",
            ...
            "Castaway", "Crabb", "Crab", "Crabber", "crabPerson", "Crest", "Darkwater", "Decks", "Decker",
            ...
            "Thick", "Thicke", "Walker", "Woods", "Wood", "Woode", "Wooden", "Woodyn", "Owlboo"]


export const crabPersonName = ["Krablante", "Mukesha", "Arun", "Nanda", "Pranay", "Jordà", "Akrosa", "Kshitija", "Piripi", "Sona", "Kama", "Gadhavi", "Semerkant", "Tirto", "Ona", "Aniruddha", "Clara", "Soun", "Prasanth", "Sarala", "Llúcia", "Josep", "Vasuda", "Nirmala", "Nasir", "Èricuj", "Tuyết", "Mercè", "Yun", "Akara", "Sreenivasa", "Uma", "Prabhu", "Guillem", "Purush", "Sala", "Marisa", "Òsca", "Wira", "Gi", "Karan", "Phan", "Chandra", "Ramachander", "Avinash", "Kishori", "Wira", "Salautha", "Aroni", "Mina", "Pratibha", "Quyền", "Pol", "Gadhavi", "Kishen", "Amrit", "Mitul", "Tirto", "Sanjeev", "Choe", "Ganeshwaran", "Prabohd", "Shivat", "Tú", "Sunita", "Rey", "Tusti", "Harendra", "Kanta", "Vasanta", "Viên", "Pratima", "Kanmani", "Gauri", "Murali", "Vinh", "Seong", "Bhadrasva", "Rakala", "Pranay", "Sumati", "Prema", "Ganesha", "Rhee", "Sanyukta", "Shailaja", "Prasert", "Mukta", "Hari", "Iyer", "Raghavanpillai", "Saraswati", "Nilam", "Tamati", "Chí", "Narang", "Lavanya", "Patariki", "Nirmala", "Kiran", "Avani", "Phan", "Satsangi", "Shripati", "Vicenç", "Hyeon", "Thu", "Huynh", "Sundararajan", "Ona", "Ranjeet", "Gerard", "Văn", "Bui", "Cintan", "Harendra", "Kishan", "Kuwat", "Narayana", "Ngo", "Sharma", "Swati", "Kolab", "Ataahua", "Joshi", "Do", "Ahlad", "Kishan", "Pol", "Ki", "Lavanya", "Apte", "Pooja", "Ganin", "Reshma", "Thulasidas", "Dhundhi", "Devavarsa", "Chittoor", "Dharabhuja", "Jayantilal", "Jaywant", "Kampan", "Irimpu", "Unmesh", "Jaitrama", "Urjavaha", "Anu", "Ramanand", "Kirit", "Agama", "Akasacamasa", "Vilok", "Gulloo", "Prassana", "Diptatapas", "Qui", "Gopicandana", "Rabindran", "Nhat", "Thadigiri", "Ekayana", "Nitesh", "Gosarya", "Naganatha", "Balakrishna", "Naidoo", "Anudrutta", "Canh", "Kanti", "Mehendale", "Hatha", "Seshadrina", "Amritaksar", "Yeno", "Janesa", "Phuong", "Jayenda", "Saunak", "Bora", "Patachli", "Candrata", "Saini", "Adra", "Pratyush", "Atandra", "Karanar", "Giriraj", "Yegammai", "Krakaca", "Somu", "Rati", "Rustagi", "Ngu", "Srini", "Agnimitra", "Parvin", "Bhanaviya", "Tatat", "Bian", "Kaushik", "Janya", "Tilak", "Jagganatha", "Chhachhi", "Avasathya", "Malik", "Ngon", "Vedavyasa", "Yogitokitoo", "Kandeya", "Jivanatha", "Sadaram", "Rajesh", "Yasha", "Jita", "Muqtedar", "Kartara", "Shubhabrata", "Anuyayin", "Naik", "Kutilagesa", "Vidi", "Sardar", "Xuan", "Gaurav", "Naimesh", "Arjun", "Cong", "Bhadriraju", "Seshu", "Deochand", "Sunanda", "Jaman", "Laxmanan", "Dhircetas", "Bui", "Kulaja", "Prasai", "Krpala", "Ganguly", "Abdhisayana", "Huynh", "Madhavra", "Padmasola", "Adhvara", "Profulla", "Sukumar", "Bakasahava", "Adhilokana", "Santharam", "Avarodha", "Sridevan", "Haricapa", "Keshava", "Kuladipaka", "Vijayaranga", "Aksata", "Rangnekar", "Karunanidhi", "Vallath", "Do", "Tam", "Bahuratha", "Surupa", "Kusumakara", "Devaranya", "Bian", "Mai", "Kishor", "Ubriani", "Gopal", "Subram", "Vidya", "Ngon", "Adesh", "Khursh", "Dhiresa", "Maran", "Uppuluri", "Selvam", "Katti", "Vasuman", "Advaya", "Linh", "Thanh", "Gramakuta", "Dinesh", "Vaninadh", "Abhinatha", "Malleshi", "Sang", "Canh", "Ilaspati", "Maiti", "Ahirbudhna", "Uday", "Gauramuk", "Yashodhara", "Paritosh", "Jayanta", "Ajitapala", "Vu", "Pham", "Narain", "Amarupa", "Barhistha", "Anniruddha", "Parthathy", "Chandrakal", "Ngon", "Anarvva", "Asvamedhas", "Dng", "Nagin", "Devavesma", "Atimanita", "Harshad", "Sharm", "Aswathanar", "Yashodhar", "An", "Hanh", "Atiratra", "Uppuluri", "Adhiratha", "Hoc", "Dein", "Cong", "Kalabhiti", "Sagar", "Jatya", "Maddukuri", "Shibu", "Hanh", "Pankaja", "Jasavanta", "Seema", "Nikhil", "Kajal", "Vivek", "Trần", "Pitambara", "Ngaire", "Lal", "Nagendra", "Jayanti", "Mata", "Choi", "Gotam", "Pallab", "Somporn", "Roimata", "Ajit", "Cardona", "Ngải", "Durga", "Naveen", "Sri", "Phương", "Danesha", "Quý", "Lakshmi", "Quintana", "Roshanara", "Suchart", "Shanta", "Rajnish", "Dipali", "Kumara", "Shripati", "Laia", "Kapil", "Putri", "Mohini", "Ananth", "Ngoy", "Channary", "Joshi", "Kishen", "Ninad", "Harsha", "Romà", "Savitri", "Wattana", "Pritha", "Manjusha", "Sunita", "Asim", "Shivali", "Phirrun", "Wiramu", "Shanti", "Quân", "Soler", "Minali", "Rukmini", "Tamboli", "Mali", "Yami", "Jayanti", "Jain", "Gonçal", "Prabhu", "Vinay", "Vishnu", "Purushottama", "Swarna", "Shekhar", "Lành", "Kumari", "Priti", "Govinda", "Pakpao", "Devaraja", "Vashudh", "Eloi", "Suman", "Mahesh", "Devi", "Sital", "Feliu", "Tama", "Cam", "Manjusha", "Salar", "Lankaja", "Maramatha", "Devek", "Sandhya", "Remshwar", "Savitri", "Amala", "Jupa", "Kishore", "Gauri", "Dipaka", "Mohana", "Kulkarni", "Hisha", "Purush", "Anju", "Vina", "Ramitra", "Sevrajil", "Shri", "Kulap", "Yontanna", "Amitabh", "Kshitij", "Bhaharat", "Tuyến", "Balak", "Yunsekar", "Girish", "Sunita", "Bình", "Malini", "Sachin", "Pratima", "Huệ", "Malati", "Prabhakara"
]
